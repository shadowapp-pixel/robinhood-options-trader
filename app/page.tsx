  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 p-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Hood Options</h1>
        ...
        {/* Tab switcher */}
        <div className="flex gap-1 mb-8 bg-slate-800/60 p-1 rounded-xl w-fit border border-slate-700">
          <button
